    ...
    var body: some View {
        GeometryReader { geometry in
            Path { path in
                ...
                width *= xScale
                path.move(to: .init(x: xOffset + width * 0.95, y: height * (0.20 + HexagonParameters.adjustment)))
            ...
            .fill(LinearGradient(gradient: .init(colors:[BadgeBackground.gradientStart,BadgeBackground.gradientEnd]),
